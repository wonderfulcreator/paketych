...
// Кнопка каталога: если мы уже на /catalog — скроллит наверх,
// если на другой странице — переходит в каталог
function CatalogButton() {
  ...
  return (
    <button
      onClick={handleClick}
      onMouseEnter={() => !isOnCatalog && router.prefetch("/catalog")}
      data-tour="catalog"
