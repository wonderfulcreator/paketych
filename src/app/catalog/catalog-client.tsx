        ...
        <div>
          ...
          <div className="mb-5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              {(selSizes.length > 0 || selCols.length > 0 || selThemes.length > 0 || selColors.length > 0 || onlySale || onlyNew || query) && (
                <button
                  onClick={() => { setSelSizes([]); setSelCols([]); setSelThemes([]); setSelColors([]); setOnlySale(false); setOnlyNew(false); setQuery(""); setVisible(24); }}
                  className="flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-3 py-2 text-sm font-semibold text-orange-600 transition hover:bg-orange-100"
                >
