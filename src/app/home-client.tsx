      ...
      <section className="container mt-10">
        ...
        <div className="mt-4">
          <MockupBanner
            ...
            desc="Два дизайна, размеры M и L, розовые атласные ленты. Оформите заявку — менеджер подготовит предложение."
            cta="Оформить заявку"
            href="/catalog?q=Мандариновая+сказка&mode=words"
      ...
      <section className="container mt-16">
        <div className="rounded-2xl bg-gray-50 px-6 py-10 md:px-12">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-4">
            {[
              { n:"01", t:"Зарегистрируйтесь", d:"Имя, компания и телефон — 1 минута. После входа откроется статус наличия и кнопка «В заявку»." },
              { n:"02", t:"Добавьте в заявку", d:"Выберите позиции в каталоге. Фильтры по коллекции, размеру и теме помогут быстро найти нужное." },
